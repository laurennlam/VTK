...
int TestPlotRangeHandlesItem(int, char*[])
{
  ...
  {
    std::cerr << "1. Unexepected range in vertical range handle : [" << rangeV[0] << ", " << rangeV[1]
              << "]. Expecting : [0, 20.25]." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "2. Unexepected range in vertical range handle : [" << rangeV[0] << ", " << rangeV[1]
              << "]. Expecting : [9.75, 30]." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "3. Unexepected range in vertical range handle : [" << rangeV[0] << ", " << rangeV[1]
              << "]. Expecting : [19.75, 30]." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "5. Unexepected range in vertical range handle : [" << rangeH[0] << ", " << rangeH[1]
              << "]. Expecting : [29.75, 60]." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "6. Unexepected range in vertical range handle : [" << rangeH[0] << ", " << rangeH[1]
              << "]. Expecting : [19.75, 60]." << std::endl;
    return EXIT_FAILURE;
  }
